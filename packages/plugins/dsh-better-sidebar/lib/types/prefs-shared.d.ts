...
export interface SidebarPrefs {
    ...
    /**
     * Whether the browser tab drops its sandboxed iframe. Sandbox OFF (the
     * default) runs any visited site with the GUI's own origin — it can read
     * session data and act as the logged-in GUI; turning it back ON keeps
     * browsed sites in an opaque origin with no GUI access. Only for trusted
