...
describe('ui-layout client apply', () => {
  ...
  it('injects no business face and attaches the layout actions', async () => {
    ...
    await fiber.await()
    const actions = {
      setSidebar: vi.fn(), setDetails: vi.fn(), setPreview: vi.fn(), toggleSidebar: vi.fn(),
      openDetails: vi.fn(), closeDetails: vi.fn(), openPreview: vi.fn(), closePreview: vi.fn(), togglePreview: vi.fn(),
    }
    ...
    layout.openPreview()
    expect(actions.openPreview).toHaveBeenCalledOnce()
  })
