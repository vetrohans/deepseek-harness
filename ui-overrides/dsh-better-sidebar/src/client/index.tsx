...
export function apply(ctx: Context): void {
  ...
  try {
    ...
    // Global tab-switch shortcuts (VSCode-ish defaults; adjust here):
    //   Cmd/Ctrl+Shift+E  资源管理器 explorer
    //   Cmd/Ctrl+Shift+G  源代码管理 git
    //   Cmd/Ctrl+Shift+J  任务管理   subagent
    //   Ctrl+`           终端       terminal
    //   Cmd/Ctrl+Shift+B  浏览器     browser
    ctx.effect(
      () => {
