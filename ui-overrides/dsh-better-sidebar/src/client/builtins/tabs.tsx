...
import { IconExplorerOutline16, IconGitOutline16, IconGlobeOutline16, IconJobsOutline16, IconTerminalOutline16 } from '../icons.tsx'
...
export function builtinTabs(ctx: Context): readonly TabDescriptor[] {
  return [
    ...
    },
    {
      id: 'explorer',
      title: () => t('explorer'),
      icon: (size: number) => <IconExplorerOutline16 size={size} />,
      order: 10,
      single: true,
    ...
    },
    {
      id: 'git',
      title: () => t('git'),
      icon: (size: number) => <IconGitOutline16 size={size} />,
      order: 20,
      single: true,
    ...
    },
    {
      id: 'subagent',
      title: () => t('subagent'),
      icon: (size: number) => <IconJobsOutline16 size={size} />,
      order: 30,
      single: true,
